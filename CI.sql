...
/* Created on:     13/12/2021 17:47:59                          */
/*==============================================================*/
...
if exists (select 1
   ...
   where r.fkeyid = object_id('CRMTB064_CLIENTE_CSS') and o.name = 'FK_CRMTB064_REFERENCE_CRMTB001')
alter table CRMTB064_CLIENTE_CSS
   drop constraint FK_CRMTB064_REFERENCE_CRMTB001
go
...
create table DM.CRMTB012_TOMADOR (
   ...
   NU_TIPO_PESSOA       SMALLINT             null,
   DE_TIPO_PESSOA       VARCHAR(50)          null,
   NU_CPF_PARTICIPANTE  NUMERIC(14)          null,
   ...
   NU_PRODUTO_OPERACAO  NUMERIC(4)           null,
   ...
   DH_INGESTAO_SILDC    DATETIME             null,
   DH_INGESTAO_BASE_INTEGRADORA DATETIME             null,
   constraint PK_CRMTB012 primary key (NU_CLIENTE, NU_AVALIACAO_TOMADOR)
)
go
...
create table DM.CRMTB013_OPERACAO (
   ...
   NU_ORDEM_GARANTIA    NUMERIC(3)           null,
   ...
   DH_INGESTAO_SILDC    DATETIME             null,
   DH_INGESTAO_BASE_INTEGRADORA DATETIME             null,
   constraint PK_CRMTB013 primary key (NU_CLIENTE, NU_AVALIACAO_OPERACAO, NU_AVALIACAO_TOMADOR, NU_PRODUTO_OPERACAO)
)
go
...
/*==============================================================*/
create table CRMTB900_PARAMETRO_MAMO (
...
/*==============================================================*/
create table CRMTB901_PONTUACAO_CLIENTE (
   NU_CPF_CNPJ          numeric(14,0)        null,
   NU_TIPO_PESSOA       numeric(2,0)         null,
   NU_CLIENTE           numeric(13,0)        null,
...
/*==============================================================*/
/* Table: CRMTB902_PONTUACAO_CLIENTE_PRD                        */
/*==============================================================*/
create table CRMTB902_PONTUACAO_CLIENTE_PRD (
   NU_CPF_CNPJ          numeric(14,0)        null,
   NU_TIPO_PESSOA       numeric(2,0)         null,
   NU_CLIENTE           numeric(13,0)        null,
